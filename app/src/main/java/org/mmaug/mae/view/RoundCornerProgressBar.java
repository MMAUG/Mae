...
import org.mmaug.mae.view.common.BaseRoundCornerProgressBar;
...
public class RoundCornerProgressBar extends BaseRoundCornerProgressBar {
  ...
  @Override protected void initStyleable(Context context, AttributeSet attrs) {
  ...
  protected void drawProgress(LinearLayout layoutProgress, float max, float progress,
